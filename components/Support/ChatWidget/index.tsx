...
export default function ChatWidget() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/support/chat/conversations/${convId}/messages`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  if (!user || !profile) {
    return (
      <div className="fixed bottom-4 right-4 z-50">
        <button
          onClick={() => window.location.href = 'mailto:support@carseraus.com?subject=Support Request'}
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 border-b border-brand-gray/20 dark:border-brand-navy/50 bg-gradient-to-r from-brand-blue/10 to-brand-green/10 dark:from-brand-blue/20 dark:to-brand-green/20">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-brand-navy dark:text-brand-white">Support Chat</h3>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <svg className="w-5 h-5 text-brand-gray dark:text-brand-white/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {!conversation ? (
                  <div className="flex flex-col items-center justify-center h-full text-center">
                    <svg className="w-16 h-16 text-brand-gray dark:text-brand-white/30 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
