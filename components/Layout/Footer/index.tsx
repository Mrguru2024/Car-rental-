        ...
        <div className="grid grid-cols-1 fold:grid-cols-2 md:grid-cols-4 gap-6 xs:gap-8 lg:gap-12">
          ...
          <div className="col-span-1 fold:col-span-2 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-brand-white/70 hover:text-brand-blue-light transition-colors"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-1.5 xs:space-y-2">
              ...
              <li>
                <Link href="/renter" className="text-brand-white/70 hover:text-brand-blue-light transition-colors">
                  For Renters
                </Link>
              </li>
              <li>
                <Link href="/dealer" className="text-brand-white/70 hover:text-brand-blue-light transition-colors">
                  For Dealers
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-1.5 xs:space-y-2">
              ...
              <li>
                <Link href="/faq" className="text-brand-white/70 hover:text-brand-blue-light transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/investors" className="text-brand-white/70 hover:text-brand-blue-light transition-colors">
                  Investors
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-brand-white/70 hover:text-brand-blue-light transition-colors">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-brand-white/70 hover:text-brand-blue-light transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/dealer-agreement" className="text-brand-white/70 hover:text-brand-blue-light transition-colors">
                  Dealer Agreement
                </Link>
              </li>
            </ul>
